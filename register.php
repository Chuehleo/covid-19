...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $username_err = $lang['username_err_2'];
    } else{
        // 指定SQL查詢字串
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){
                    $username_err = $lang['username_err_3'];
                } else{
    ...
    if(empty(trim($_POST["password"]))){
        ...
        $password_err = $lang['password_err_2']; 
    } else{
        $password = trim($_POST["password"]);
    }
    //驗證確認密碼
    if(empty(trim($_POST["confirm_password"]))){
        $confirm_password_err = $lang['confirm_err'];   
    } else{
        $confirm_password = trim($_POST["confirm_password"]);
        if(empty($password_err) && ($password != $confirm_password)){
            $confirm_password_err = $lang['confirm_err_2'];  
        }
    }
    //在匯入至資料庫前查看是否有輸入錯誤
...
<body>
    ...
    <nav class="navbar">
            ...
            <div class="lang-menu">
                ...
                <ul>
                    <li>
                        <a href="register.php?lang=tw" class="tw">繁體中文</a>
                    </li>
                    <li>
                        <a href="register.php?lang=en" class="en">English</a>
                    </li>
        ...
        <div class="max-width">
            ...
            <li> 
              <div class="login">
                <a href ="login.php" class="login-btn"><?php echo $lang['login'] ?></a>
             </div>
            </li>
            </ul>
            <div class="menu-btn">
    ...
    <div id="form_2">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="inputbox">
                ...
                <input type="password" name="password" placeholder=<?php echo $lang['placeholder_2'] ?> <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $password; ?>">
                <?php echo '<div class="alert">' . $password_err . '</div>'; ?>
            </div>
            <div class="inputbox">
                <label><?php echo $lang['confirm'] ?></label>
                <input type="password" name="confirm_password" placeholder=<?php echo $lang['placeholder_3'] ?> <?php echo (!empty($confirm_password_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $confirm_password; ?>">
                <?php echo '<div class="alert">' . $confirm_password_err . '</div>'; ?>
            </div>
            <div class="btn">
                <input type="submit" class="addbtn" value="<?php echo $lang['submit'] ?>">
                <input type="reset" class="putbtn" value="<?php echo $lang['reset'] ?>">
            </div>
            <p><?php echo $lang['description_2'] ?> <a href="login.php"><?php echo $lang['login'] ?></a></p>
        </form>
        </div>
       </div>
    </div>  
           ...
           <div class="map">
               <img src="images/map.png" style="border:none;"></img>
           </div> 
