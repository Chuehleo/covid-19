...
<meta charset="UTF-8">
    ...
    <script>
      ...
      window.zoomInn = svgPanZoom('#canvas', {
      zoomEnabled: true,
...
<div class="scroll-up-btn">
    ...
    <nav class="navbar">
            ...
            <div class="lang-menu">
                ...
                <ul>
                    <li>
                        <a href="welcome.php?lang=tw" class="tw">繁體中文</a>
                    </li>
                    <li>
                        <a href="welcome.php?lang=en" class="en">English</a>
                    </li>
        ...
        <div class="max-width">
            ...
            <li>
              <div class="login">
                <a href="logout.php" class="login-btn"><?php echo $lang['logout'] ?></a>
             </div>
            </li>
            <li><a class="disabled" style="font-size:15px;"><?php echo $lang['greet'] ?><?php echo htmlspecialchars($_SESSION["username"]), " !";?></a></li>
...
<section class="twmap" id="twmap">
    ...
    <div class="title_area">
        <div class="cityname">
            <h1>{{now_area.place}}<br></h1>
    </div>
        <button onclick=change_css() class="infoClose"><span class="iconClose"></span></button>
    </div>
    
    <div class="infobody" v-if="now_area">
        <div class="infocolumn">
            <div>
                <span><?php echo $lang['confirm_case'] ?></span>
                <strong>{{now_area.confirmed}}</strong>
            </div>      
            <div>
                <span><?php echo $lang['new_case'] ?></span>
                <h2 style="color:#ff8726;">{{now_area.new}}</h2>
            </div>  
      </div>
    </div>
